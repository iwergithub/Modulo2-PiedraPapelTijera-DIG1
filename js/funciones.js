document.addEventListener("DOMContentLoaded", function () {
    ...
    function resultado(u, c) {
        if ((u == "piedra" && c == "piedra") ||
            (u == "papel" && c == "papel") ||
            (u == "tijera" && c == "tijera")) {
                imageElement.src = "./imgs/empate.png";
                imageElement2.src = "./imgs/cup3.png";
            ...
            (u == "papel" && c == "piedra") ||
            (u == "tijera" && c == "papel")) {
            imageElement.src = "./imgs/win.png";
            imageElement2.src = "./imgs/cup.png";
            txtSubResultado.innerHTML =`${u} gana a ${c}`;
        } else if (
            (u == "piedra" && c == "papel") ||
            (u == "papel" && c == "tijera") ||
            ...
            imageElement.src = "./imgs/lose.png";
            txtSubResultado.innerHTML =`${c} gana a ${u}`;
            imageElement2.src = "./imgs/cup2.png";
        }
    }
